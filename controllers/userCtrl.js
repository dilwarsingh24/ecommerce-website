        ...
        try {
            ...
            const message = {
                ...
                html: `
                    ...
                    <h2 style="text-align: center; text-transform: uppercase;color: teal;">Welcome to the KESHU SHOP .</h2>
                    <p>Congratulations! You're almost set to start using KESHU✮SHOP.
